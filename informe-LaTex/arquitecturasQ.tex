\parte{Especificación de la arquitectura Q}\label{apendiceQ}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Instrucciones de 1 operando origen}
