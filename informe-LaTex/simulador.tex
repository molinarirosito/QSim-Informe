...
El \textit{parser} controlará el código escrito por el alumno y de acuerdo a la gramática del lenguaje correspondiente a la versión \qi\ elegida elegido, mostrará alguno de los siguientes estados:
...
Por ejemplo, la una instrucción \codecent{ADD [AAAA],0x000F} suma el valor 15 al contenido de la celda cuya dirección es \code{AAAA}, y el resultado de ensamblar esta celda es el siguiente código máquina: \codecent{0010001000000000 1010101010101010 0000000000001111}
...
\item  \textbf{Git}
Se eligió \textit{git} como repositorio externo para trabajar colaborativamente durante el desarrollo, dado que es una herramienta que muy extendida en los desarrollos de software libre.
